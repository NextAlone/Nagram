...
* DISABLED ADS
    * YES!!1 (f985223fcb0eac8ce382595f940aaac8cae1454e)
    * no more sponsored messages, we still download them but do not display
        * we still count views for this ADS to hide our behavior of the app "who don't earn money
          for TG" (d4243d3bcd676e7b2e35626d9969a0de3a448e1d)
...
* 6 accounts instead of 3
    * client support upto 6 accounts (384bf4421f26773a7f970578ef4bfe6676fbe312)
...
* DISABLED REMOTE DELETIONS
    * NO more deletions via GCM PUSHES (chats and messages), WTF 💩 (
      5815025ab8fbc71d2b1be59dd2750f6edfb0c2b8)
    ...
    * NO more remote deletions in secret chats (3a87a80cb44f8e646a884a3cccb0d41306f2dbb9
      ec5ddde611eaa795ffe7dc6d58a8e9090872f6b5)
...
* FULL ACCESS in "restrict saving content" chats
    * screenshots, gif imports, media saving (8a35b741310fd29acc06993cf260af98bbf36057
      bd5c0a3c7e66fe0336cbcbd2837861e705e6053c)
    * DO NOT save GIFS via saving gifs
        * just click on them and choose "save to gallery" (d9cdf1c38dc4db04707b093116de32975b276b95)
    ...
    * d09053dad35a97470d23da8680cd360a03b360d9
* FULL ACCESS in secret chats (GREEN ONES!)
    * you can download any medias and documents (f61d6147fe307214fc6f4853c513668ee4ba96cd)
    * you can take screenshots or record your screen
        * WTF apple can do that, we can do it too! (0256c6891b657975566b98700a349afb55fe81b1)
* GIFs have controls
    * you can start/stop GIFs or navigate on a timeline
* KEEP CACHED chats
    * cached chats are always with you even if you're BANNED (
      03307a9d90b86bcb5864880592110c4ee3427ebb)
...
* HISTORY in private chats
    * message separated inside by RFC1123 timestamp field (aa1c84667d1a889e580e3557cb1f3619898b1092
      2a27946fd18761efaf3ba03d58343e5b2bfc99fa 8d7efe07173ffaa3bd1d7f9c793626aacb79f6ed)
...
* NO MORE `edit_hide`
    * telegram can send you messages with `edit_hide==true` to hide what this message has been
      edited (9b87154dce324cb4eeb0cd3c02e32f7815c67359 80fc81ceabd250fb87d23d516eb065c7ca72b889)
...
* APP name changed & APP icon changed & APP package changed
    * of you want to run using old name just rollback those commits and build the app
        * 14734a444cac5883e3d169808bf4162da3aa7cdc 951084eb38d75f6c52a21be77648f66f4eb07712
          ca70b56631ce57f45bf6dc443dc35141b1429109 3aa519bc456e4cefdd43ecc9016e22ee672b5e53
* APPs api & hash are changed for legit TG client (f8eb8ab357a0f557062a35f51e05e04c2919882c)
