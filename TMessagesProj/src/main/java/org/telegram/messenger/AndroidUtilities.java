...
//        mapRSA.put("web850", "");
        ...
        try {
            for (Map.Entry<String, String> m : mapRSA.entrySet()) {
                ...
                System.out.printf("%nRSA `%s`%nX509:%n`%s`%n%nSHA256 `%s`%n%n", m.getKey(), Base64.encodeToString(c.getEncoded(), Base64.NO_WRAP), Utilities.bytesToHex(Utilities.computeSHA256(c.getEncoded())));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
