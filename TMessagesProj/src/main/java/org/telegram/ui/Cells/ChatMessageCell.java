...
public class ChatMessageCell extends BaseCell implements SeekBar.SeekBarDelegate, ImageReceiver.ImageReceiverDelegate, DownloadController.FileDownloadProgressListener, TextSelectionHelper.SelectableView, NotificationCenter.NotificationCenterDelegate {
    ...
    private boolean checkTextSelection(MotionEvent event) {
        ...
        if (textSelectionHelper == null || MessagesController.getInstance(currentAccount).isChatNoForwardsForced(currentMessageObject.getChatId()) || (currentMessageObject.messageOwner != null && currentMessageObject.messageOwner.noforwards)) {
            return false;
        }
