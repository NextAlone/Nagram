    ...
    private CharSequence formatArchivedDialogNames() {
        ...
        for (int a = 0, N = dialogs.size(); a < N; a++) {
            ...
            if (dialog.unread_count > 0) {
                builder.setSpan(new TypefaceSpan(AndroidUtilities.getTypeface("fonts/Vazir-Medium.ttf"), 0, Theme.getColor(Theme.key_chats_nameArchived)), boldStart, boldEnd, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
