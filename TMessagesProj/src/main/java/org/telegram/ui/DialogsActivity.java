...
//    }
    ...
    private void updateDialogsHint() {
        ...
        } else if (folderId == 0 && !getMessagesController().premiumPurchaseBlocked() && BirthdayController.getInstance(currentAccount).contains() && !NekoConfig.disableTrending.Bool()) {
