...
public class LocationActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        if (messageObject == null && (locationType == LOCATION_TYPE_SEND || locationType == LOCATION_TYPE_SEND_WITH_LIVE)) {
            ...
            searchAreaButton.setTypeface(AndroidUtilities.getTypeface("fonts/Vazir-Medium.ttf"));
        ...
        emptyTitleTextView.setTypeface(AndroidUtilities.getTypeface("fonts/Vazir-Medium.ttf"));
