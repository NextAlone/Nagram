...
public class InternalUpdater {
    ...
    static final long CHANNEL_METADATA_ID = 1549161373;
    static final String CHANNEL_METADATA_NAME = "Zngram_metadata";
    static final long CHANNEL_APKS_ID = 1630270471;
    static final String CHANNEL_APKS_NAME = "Zngram_updates";
